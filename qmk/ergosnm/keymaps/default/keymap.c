...
[0] = LAYOUT(
  ...
  KC_LALT, KC_LGUI, KC_HOME, KC_END,  MO(1),           KC_SPC,  MO(2),   KC_DEL,  XXXXXXX, XXXXXXX, XXXXXXX,          KC_ENT,  KC_LBRC, KC_RBRC, MO(2),   MO(1) 
),

[1] = LAYOUT(
  KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,                                                         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_PSCR,
  KC_PENT, _______, KC_P7,   KC_P8,   KC_P9,  KC_PPLS,                                                       _______, _______, _______, KC_F11,  KC_F12,  KC_DEL,
  _______, _______, KC_P4,   KC_P5,   KC_P6,  KC_PMNS,                                                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
  _______, KC_P0,   KC_P1,   KC_P2,   KC_P3,  KC_PDOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
